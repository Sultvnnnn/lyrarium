            ...
            >
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                {song.album && (
                  <Link
                    ...
                    className="text-caption uppercase text-muted-foreground hover:text-accent tracking-widest truncate max-w-[55%] transition-colors hover:underline underline-offset-2"
                  >
                    {song.album}
                  </Link>
                )}
              ...
              <div className="flex items-end justify-between gap-4">
                <div className="max-w-md min-w-0">
                  ...
                  <h3 className="mt-1 text-heading-sm md:text-heading font-light leading-heading-sm md:leading-heading text-foreground tracking-[-0.02em] line-clamp-2">
                    {song.title}
                  </h3>
                </div>
