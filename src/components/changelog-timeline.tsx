...
const MILESTONES: Milestone[] = [
  {
    ...
    details: [
      ...
      "Dual-language support (ID/EN) with sharp 0px toggle, explicit prompt language directive, and independent permanent database caching in 'lyra_insights'.",
      "Server-side pre-hydration of cached insights directly in LyricsPage for 0ms initial load and seamless instant tab switching.",
      "Isolated per-language AbortControllers preventing active streams from aborting or freezing when switching between language tabs.",
