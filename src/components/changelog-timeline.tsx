...
const MILESTONES: Milestone[] = [
  {
    ...
    details: [
      ...
      "Updated Ask Lyra prompt copy with evocative narrative inquiry ('What does this song truly mean? Explore the story and emotion behind the lyrics.').",
      "Integrated Lyra section inside the main lyrics grid column, allowing the sticky YouTube video carousel and About the artist sidebar to scroll seamlessly alongside both lyrics and Lyra.",
      "Strict em-dash (—) elimination in both system prompts and streaming token sanitization.",
      "Minimal editorial footer with English AI disclaimer, omitting internal model identifiers.",
      "In-memory rate limiter on route handler /api/lyra (60 req/min for dev/localhost, 10 req/min for production).",
    ],
  },
  {
    id: "v0.12.1",
