...
export const MILESTONES: Milestone[] = [
  {
    ...
    version: "v0.13.0",
    date: "Sep 25–26, 2026",
    title: "Ask Lyra — Editorial AI Lyrical Interpretation & Dual-Language Engine",
    category: "Features",
    tag: "AI / Interpretation Engine",
    summary:
      "Launched 'Ask Lyra' — an editorial AI lyrical interpretation engine. Integrates zero-dependency OpenAI-compatible SSE streaming, bilingual Supabase database caching (lyra_insights), interactive button-triggered revelation with 0-token simulated typewriter streaming, and a kinetic sliding language switcher matching the artist discography aesthetic.",
    details: [
      "Zero-dependency SSE streaming adapter with transient retry, 30-second AbortController timeout, and 6,000-character payload slicing.",
      "Permanent Supabase Postgres cache (lyra_insights) with compound unique index (song_id, language) ensuring instant retrieval and zero redundant API costs.",
      "Bilingual interpretation engine defaulting to English (EN) with full Indonesian (ID) support, tuned for poetic depth and narrative subtext.",
      "Interactive button-first reveal flow: interpretation text remains hidden until user explicitly clicks [ Ask Lyra ] or [ Tanya Lyra ].",
      "Simulated typewriter streaming for cached entries: plays a smooth 1.5s editorial reveal at 0 token cost, preserving tactile streaming delight without re-querying provider API.",
      "Kinetic sliding language toggle pinned to the far right, matching the artist discography album switcher physics with framer-motion layoutId and spring damping.",
      "Silky framer-motion crossfade transitions (opacity and subtle translate) when switching between language interpretations.",
      "Unified left-column integration: embedded Lyra inside .lyrics-grid-layout so the YouTube video carousel and About the artist sidebar scroll alongside both lyrics and Lyra without premature cutoff.",
      "Evocative editorial inquiry copy replacing AI-slop placeholders: 'What does this song truly mean? Explore the story and emotion behind the lyrics.'",
      "Stripped internal model identifiers from user view, complemented by an elegant English editorial disclaimer ('Lyra is an editorial AI assistant and can make mistakes.').",
      "Strict em-dash sanitization across both system prompt instructions and streaming token pipelines.",
      "In-memory sliding-window rate limiter on /api/lyra (60 req/min for local development, 10 req/min for production).",
    ],
  },
  {
    id: "v0.12.1",
